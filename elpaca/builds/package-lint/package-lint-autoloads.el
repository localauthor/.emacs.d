...

;;; Generated autoloads from package-lint-test.el

(register-definition-prefixes "package-lint-test" '("package-lint-test-add-package-lint-foobar-to-archive" "test-thing"))

;;; End of scraped data
